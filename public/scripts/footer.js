...
let footerHTML = `<div class='col'>
    ...
    <div class='col'>
      <h3>link to me.</h3>
      <p><img src="https://illuminesce.neocities.org/images/links/illuminesce_88x31.gif" alt="A 88x31 banner to link to my site. Text says, illuminesce. Includes a jumping dinosaur.">&nbsp;&nbsp;<img src="https://illuminesce.neocities.org/images/links/illuminesce_88x31.png" alt="A 88x31 banner to link to my site. Text says, illuminesce."></p>
    <div class='col'>
      <h3>like my work?</h3>
